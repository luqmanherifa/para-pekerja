      ...
      <div className="max-w-5xl mx-auto px-8 flex items-center justify-between h-14">
        ...
        >
          <Hammer
            ...
            strokeWidth={2.5}
          />
          <span className="font-bold text-sm text-gray-900 tracking-tight group-hover:text-green-600 transition-colors duration-150">
            Para Pekerja
          </span>
        </Link>
        ...
        <div className="flex items-center gap-0.5">
          {NAV_LINKS.map(({ label, href, icon: Icon }) => (
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-gray-500 hover:text-green-600 hover:bg-green-50 transition-all duration-150"
            >
        ...
        {user ? (
          <div className="flex items-center bg-gray-100 rounded-xl overflow-hidden shrink-0">
            ...
            <button
              onClick={onLogout}
              className="flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-gray-500 hover:text-red-500 hover:bg-red-50 transition-all duration-150"
            >
